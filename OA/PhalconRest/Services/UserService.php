...
use OA\PhalconRest\UserException,
    ...
    OA\PhalconRest\Services\AuthService,
...
class UserService extends \Phalcon\Mvc\User\Plugin {
    ...
    public function activate()
    {
        ...
        if (!$this->request->hasQuery('mailtoken')) {
            ...
            throw new UserException(ERR::GEN_NOTFOUND, 'You will need a mailtoken to activate');
        }
        ...
        if (!$user) {
            ...
            throw new UserException(ERR::DATA_NOTFOUND, 'Could not activate, user not found');
        }
        ...
        if (!$user->save()) {
            ...
            throw new UserException(ERR::DATA_FAIL, 'User found, but could not activate.');
        }
    ...
    public function register($data)
    {
        ...
        if ($user && $user->hasAccountType(AccountTypes::USERNAME)) {
            ...
            throw new UserException(ERR::DATA_DUPLICATE, 'User already exists.');
        }
        ...
        try {
            ...
            $this->db->rollback();
            throw new UserException(ERR::USER_CREATEFAIL, $e->getMessage());
        }
    ...
    public function me()
    {
        ...
        if (!$user){
            ...
            throw new UserException(ERR::USER_NOTFOUND);
        }
    ...
    public function login()
    {
        ...
        if (is_null($bearer = $this->request->getBearer())) {
            throw new UserException(ERR::AUTH_NOBEARER);
        };
        ...
        if (is_null($username)) {
            ...
            throw new UserException(ERR::AUTH_NOUSERNAME);
        };

        if (!$this->authservice->login($bearer, $username, $password)) {

            throw new UserException(ERR::AUTH_BADLOGIN, 'Failed to login.');
        }
